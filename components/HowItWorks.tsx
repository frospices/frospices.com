...
const data = {
  steps: [
    ...
    },
    {
      ...
      title: "Enjoy",
      icon: '/enjoy.svg',
      content: "Eat delicious homemade food made by certified chefs in your community!"
    }
  ]
};
...
const HowItWorks = () => (
  <Flex padding={["xl", "xxl"]} flexDirection="column" alignItems="center" justifyContent="center" my="xs">
    ...
    <Flex justifyContent="space-between" flexDirection={["column", "row"]}>
      {data.steps.map(item => (
        <Box key={item.id} p="sm" textAlign="center" width={["100%", "33.333%"]}>
