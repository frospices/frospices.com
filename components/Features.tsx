  ...
  return (
    ...
    >
      <Text
        ...
        textAlign="center"
      >
        Advantages for both chef and consumers
      </Text>
      <Text
        fontSize="md"
        my="md"
      ...
      >
        <Box flex="1" px={["md", "xsl"]} ml={["0", "sm"]}>
          ...
          <Text fontWeight="bold" fontSize="xl" color="gray_900">
            Become a Chef.
          </Text>
          <Text width={["100%", "80%"]} my="xs">
            Unleash your culinary skills and become your own boss by offering
            homemade meals and earning income at your own pace.
          </Text>
        ...
        <Flex justifyContent="right" flex="1">
          <Image as="img" src="Chef.jpg" alt="Chef" flex="1" />
        </Flex>
      </Flex>
      <Flex
        mt={["lg", "xl"]}
      ...
      >
        <Image as="img" src="customer.jpeg" alt="Customer" flex="1" />
        <Box flex="1" mx={["0", "sm"]} px={["md", "xl"]}>
          ...
          <Text width={["100%", "80%"]} my="xs">
            Enjoy the comfort of a home-style meal with the convenience of
            delivery services.
          </Text>
