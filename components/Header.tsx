...
const NavLink = ({ href, label }: Props) => {
  ...
  return (
    <Link href={href} passHref>
     <Text fontWeight={asPath === href ? 'bold': 'bold'}>
      {label}
     </Text>
    </Link>
  )
...
const Header = () => {
  ...
  >  
     ...
     <Box display={["none", "flex"]} justifyContent="space-between" alignItems="center" flex="1">
      <Flex justifyContent="space-between" alignItems="center" mx="lg" mt="sm">
       <Box mx="xs">
