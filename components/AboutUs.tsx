  ...
  return (
    <Flex id="about-us" padding={["xl", "xxl"]} flexDirection="column" justifyContent="center" alignItems="center" width={["100%", "70%"]} mx="auto">
      ...
      <Text my="sm">
        ...
        With a wide range of menu items to choose from, you'll never get bored with your taste buds traveling the world!
      </Text>
      <Text my="sm">
        Whether you're in the mood for a savory stew, spicy pepper soup, or a sweet dessert, Frospices has something for everyone. 
      ...
      <Text my="sm">
        ...
        We can't wait to share our love of African cuisine with you!
      </Text>
    </Flex>
  );
};
